...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API REST para ingestão da PokeAPI e consulta de métricas de Pokémon. Autenticação via Bearer Token (Sanctum). A rota de métricas é pública.',
    ],

    'ui' => [
        'title' => 'PokeAPI Estech',
    ],
